import { HOST, TOKEN_NAME, API_CLIENT_ID, API_CLIENT_SECRET } from '../../../shared/var.constants';
import { HttpClient, HttpHeaders } from '@angular/common/http';
import { Observable } from 'rxjs';
import { Injectable } from '@angular/core';
import { tokenApi } from '../shared/token';
...
export class LoginService {
  ...
  urltoken = `${HOST}/oauth/token`;
  urltokenAnular = `${HOST}/usuarios/anular`;
  urlLogin = `${HOST}/login`;
  constructor(
